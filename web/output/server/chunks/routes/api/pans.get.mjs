...
const pans_get = defineEventHandler(async (event) => {
  ...
  try {
    ...
    console.error("\u670D\u52A1\u7AEF\u83B7\u53D6\u5E73\u53F0\u6570\u636E\u5931\u8D25:", error);
    throw createError({
      statusCode: 500,
      statusMessage: "\u83B7\u53D6\u5E73\u53F0\u6570\u636E\u5931\u8D25"
    });
  }
});

export { pans_get as default };
//# sourceMappingURL=pans.get.mjs.map
